...
namespace CWI.MCP.API.Controllers.MCP
{
    ...
    public class SysController : BaseController
    {
        ...
        public object TestConnection()
        {
            ...
            //string s4 = RC4CryptoUtil.EncryptRC4(s1, Consts.RC4_KEY,RC4CryptoUtil.EncoderMode.HexEncoder);
            //string s5= RC4CryptoUtil.DecryptRC4(s4, Consts.RC4_KEY, RC4CryptoUtil.EncoderMode.HexEncoder);
            return OK();
        }
        ...
        public object Test()
        {
            LogUtil.Debug("调用debug-25");
            LogUtil.Error("调用error-25");
            LogUtil.Info("调用Info-25");
            LogUtil.Warn("调用warn-25");
            return OK();
        }
