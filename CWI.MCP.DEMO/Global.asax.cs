...
using CWI.MCP.Controllers.OPEN;
using CWI.MCP.Common.Extensions.MVC;

namespace CWI.MCP.DEMO
{
    /// <summary>
    /// MvcApplication
    /// </summary>
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute("Error404"
                ...
                , null
                , new string[] { "CWI.MCP.Controllers.DEMO" });
            ...
            routes.MapRoute(
                ...
                new { controller = "Sys", action = "Index", id = UrlParameter.Optional },
                new string[] { "CWI.MCP.Controllers.DEMO" });
        }
        ...
        {
            Response.Cookies["MCP_DEMO_SessionId"].Value = HttpContext.Current.Session.SessionID;
            SessionUtil.AppSign = "MCP_DEMO";
        }
