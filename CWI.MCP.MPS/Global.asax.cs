...
using CWI.MCP.Controllers.MPS;
using CWI.MCP.Common.Extensions.MVC;

namespace CWI.MCP.MPS
{
    /// <summary>
    /// MvcApplication
    /// </summary>
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute("Error404"
                ...
                , null
                , new string[] { "CWI.MCP.Controllers.MPS" });
        ...
        {
            Response.Cookies["MCP_MPS_SessionId"].Value = HttpContext.Current.Session.SessionID;
            SessionUtil.AppSign = "MCP_MPS";
        }
