...
using CWI.MCP.Controllers.BPS;
using CWI.MCP.Common.Extensions.MVC;

namespace CWI.MCP.BPS
{
    /// <summary>
    /// MvcApplication
    /// </summary>
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute("Error404"
                ...
                , null
                , new string[] { "CWI.MCP.Controllers.BPS" });
        ...
        {
            Response.Cookies["MCP_BPS_SessionId"].Value = HttpContext.Current.Session.SessionID;
            SessionUtil.AppSign = "MCP_BPS";
        }
