...
namespace CWI.MCP.Models
{
    ...
    /// </summary>
 	[Serializable]
    [TableMapping(TableName = "mcp_template_type")]
	public class McpTemplateTypeInfo : Model
    {
		/// <summary>
		/// 模版业务ID
		/// </summary>
		[TableMapping(FieldName = "template_business_id")]
		public string TemplateBusinessId { set; get; }

		/// <summary>
		/// 模版类型ID
		/// </summary>
		[TableMapping(FieldName = "template_type_id", PrimaryKey = true)]
		public string TemplateTypeId { set; get; }

		/// <summary>
		/// 模版类型名称
		/// </summary>
		[TableMapping(FieldName = "template_type_name")]
		public string TemplateTypeName { set; get; }

		/// <summary>
		/// 默认模板ID
		/// </summary>
		[TableMapping(FieldName = "default_template_id")]
