    ...
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute("Error404"
                ...
                , null
                , new string[] { "CWI.MCP.Controllers.OPEN" });
        ...
        {
            Response.Cookies["MCP_OPEN_SessionId"].Value = HttpContext.Current.Session.SessionID;
            SessionUtil.AppSign = "MCP_OPEN";
        }
