...
namespace CWI.MCP.Common
{
    ...
    public enum PrintOrderStatusType
    {
        ...
        /// 已经推送，但还未收到打印机结果
        /// </summary>
        [EnumDescription("已经推送，但还未收到打印机结果")]
        PushedNoResult = 5,
    ...
    /// 打印机辅助命令执行结果
    /// </summary>
    public enum PrintCmdResultStatuCode
    {
        /// <summary>
        /// 未执行
        /// </summary>
    ...
    /// 打印机辅助201指令说明
    /// </summary>
    public enum PrintCmdStatue
    {
        /// <summary>
        /// 修改域名
        /// </summary>
        [EnumDescription("修改域名")]
        RenameDomain = 1,

        /// <summary>
        /// 关机重启
        /// </summary>
        [EnumDescription("关机重启")]
        Restart = 2,

        /// <summary>
        /// 上传日志
        /// </summary>
        [EnumDescription("上传日志")]
        UploadLog = 3,
    }
}