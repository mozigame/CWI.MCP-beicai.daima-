...
namespace CWI.MCP.Common
{
    ...
    public class RC4CryptoUtil
    {
        ...
        public static String EncryptRC4(String data, String pass, RC4CryptoUtil.EncoderMode em)
        {
        ...
        /// <param name="em">编码模式</param>
        /// <returns>明文</returns>
        public static String DecryptRC4(String data, String pass, RC4CryptoUtil.EncoderMode em)
        {
            if (data == null || pass == null) return null;
            if (em == EncoderMode.Base64Encoder)
        ...
        public static String EncryptRC4(String data, String pass)
        {
            return EncryptRC4(data, pass, EncoderMode.Base64Encoder);
        }
        ...
        /// <param name="pass">密码</param>
        /// <returns>明文</returns>
        public static String DecryptRC4(String data, String pass)
        {
            return DecryptRC4(data, pass, EncoderMode.Base64Encoder);
        }
