...
{
    public sealed class RSACryptionUtil
    {
        #region 公有方法
        ...
        public static string RSASign(string content, string privateKey, string inputCharset = "utf-8")
        {
        ...
        public static bool RASVerify(string content, string signedString, string publicKey, string inputCharset = "utf-8")
        {
            try
            {
                bool result = false;
            ...
            {
                LogUtil.Error(string.Format("传入签名：{0} 格式错误。",signedString));
                return false;
            }
        }
